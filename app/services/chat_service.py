...
class ChatService:
    ...
    def get_or_create_session(self, session_id: Optional[str] = None) -> str:
        ...
        #New session with this ID (e.g. client sent and ID that wasd never saved).
    ...
    def process_realtime_message(self, session_id: str, user_message: str) -> str:
        ...
        Uses the same session as process_message so history is shared. Raises ValupError if realtime_service is None.
        """
